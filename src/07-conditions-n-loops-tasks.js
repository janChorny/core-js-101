...
function doRectanglesOverlap(rect1, rect2) {
  ...
  if (rect1.top > bottom2 || rect2.top > bottom1) return false;
  if (rect1.left > right2 || rect2.left > right1) return false;
  return true;
}
...
function findFirstSingleChar(str) {
  for (let i = 0; i < str.length; i += 1) {
    const uniqLetter = str.charAt(i);
    if (str.indexOf(uniqLetter) === i && str.indexOf(uniqLetter, i + 1) === -1) {
      return uniqLetter;
    }
  }
  return null;
